...
class PlayLostModeSound implements IActionSourceDevices
{
  public array $osType = ["Android", "Apple"];

  private string $actionType = "PlayLostModeSound";
  public string $actionIdentifier = "PlayLostModeSound_ID";
  ...
  public function checkCompatibility(array $device, array $license): bool
  {
    ...
    try {
      ...
      if (!in_array('LICENSE_ADVANCED_EDUBASE_ACTIVE', $license)) {
        return false;
      }
