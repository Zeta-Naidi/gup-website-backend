...
class EnableBluetooth implements IActionSourceDevices
{
  ...
  private string $actionType = "EnableBluetooth";
  public string $actionIdentifier = "EnableBluetooth_ID";
      ...
      if (
        ...
        && (
          (
            ...
            //$device['isBluetoothActive'], 'true_false', false
          )
          ||
          (
