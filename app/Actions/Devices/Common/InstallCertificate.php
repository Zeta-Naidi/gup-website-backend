...
class InstallCertificate implements IActionSourceDevices
{
  public array $osType = ["Windows", "Android"];

  private string $actionType = "InstallCertificate";
  public string $actionIdentifier = "InstallCertificate_ID";
