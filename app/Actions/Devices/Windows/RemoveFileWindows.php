...
class RemoveFileWindows implements IActionSourceDevices
{
  public array $osType = ["Windows"];

  private string $actionType = "RemoveFileWindows";
  public string $actionIdentifier = "RemoveFileWindows_ID";
  ...
  public function checkCompatibility(array $device, array $license): bool
  {
    ...
    try {
      ...
      if (!in_array('LICENSE_ADVANCED_EDUBASE_ACTIVE', $license) || !in_array('LICENSE_ADVANCED_BUSINESS_PLUS_ACTIVE', $license)) {
        return false;
      }
