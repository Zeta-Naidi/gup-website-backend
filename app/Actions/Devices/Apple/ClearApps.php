...
class ClearApps implements IActionSourceDevices
{
  ...
  private string $actionType = "ClearApps";
  public string $actionIdentifier = "ClearApps_ID";
    ...
    try {
      if (
        ...
        && (
          ...
          //$device['osVersionExpo'] >= 10
          //$device['modelName'] != DeviceModel::AppleTV
          // 'isLostModeEnabled', 'true_false', false
        )
      ) {
        return false;
      }
