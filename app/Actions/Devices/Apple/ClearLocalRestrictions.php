...
class ClearLocalRestrictions implements IActionSourceDevices
{
  public array $osType = ["Apple"];
  private bool $actionStatusActive = true;


  private string $actionType = "ClearLocalRestrictions";
  public string $actionIdentifier = "ClearLocalRestrictions_ID";
